<div class="widget-content">
    <ul class="category-list ">
        ...
        <li><a href="{{ route('user.profile') }}"><i class="fa fa-cog" aria-hidden="true"></i>
                Settings</a></li>
        <li><a href="#"><i class="fa fa-credit-card" aria-hidden="true"></i>
        ...
        <li><a href="#"><i class="fa fa-indent" aria-hidden="true"></i> Add
                a Property </a></li>
        <li><a href="#"><i class="fa fa-key" aria-hidden="true"></i>
                Security </a></li>
